...
final class ObjectToArrayCompositeTransformer implements TransformerInterface
{
    ...
    public function __invoke(mixed $input, array $context = []): array
    {
        ...
        {
            case 'useReflection': $method = (new ObjectToArrayUsingReflectionTransformer($this->transform)); break;
            case 'usePublicProperties': $method = (new ObjectToArrayUsingPublicPropertiesTransformer($this->transform)); break;
            case 'useGetterBased': $method = (new ObjectToArrayUsingGettersTransformer($this->transform)); break;
            case 'useJsonEncodeDecode': $method = (new ObjectToArrayUsingJsonEncodeDecodeTransformer()); break;
            default:
